...
//    }
//    myvk::Instance::gInstance->GetPhysicalDevice() = physicalDevice;
//}
...
//    vkGetPhysicalDeviceFeatures(myvk::Instance::gInstance->GetPhysicalDevice(), &deviceFeatures);
...
//    if (vkCreateDevice(myvk::Instance::gInstance->GetPhysicalDevice(), &createInfo, &allocatorsCallbacks, &myvk::Device::gDevice->GetDevice())) {
//        throw std::runtime_error("Failed to create the logical device");
//    }
//    vkGetDeviceQueue(myvk::Device::gDevice->GetDevice(), ctx.graphicsFamily, 0, &ctx.graphicsQueue);
//    vkGetDeviceQueue(myvk::Device::gDevice->GetDevice(), ctx.presentFamily, 0, &ctx.presentQueue);
//
//    ctx.vkCmdDebugMarkerBeginEXT = (PFN_vkCmdDebugMarkerBeginEXT)vkGetDeviceProcAddr(myvk::Device::gDevice->GetDevice(), "vkCmdDebugMarkerBeginEXT");
//    ctx.vkCmdDebugMarkerEndEXT = (PFN_vkCmdDebugMarkerEndEXT)vkGetDeviceProcAddr(myvk::Device::gDevice->GetDevice(), "vkCmdDebugMarkerEndEXT");
//    ctx.vkCmdDebugMarkerInsertEXT = (PFN_vkCmdDebugMarkerInsertEXT)vkGetDeviceProcAddr(myvk::Device::gDevice->GetDevice(), "vkCmdDebugMarkerInsertEXT");
//}

//void DestroyLogicalDevice(VkContext& ctx)
//{
//    VkAllocationCallbacks allocatorsCallbacks = CreateCustomAllocatorsCallback(ctx.customAllocators);
//    vkDestroyDevice(myvk::Device::gDevice->GetDevice(), &allocatorsCallbacks);
//}
...
//    if (vkCreateCommandPool(myvk::Device::gDevice->GetDevice(), &poolInfo, nullptr, &ctx.commandPool) != VK_SUCCESS) {
//        throw std::runtime_error("failed to create command pool!");
//    }
//    SET_NAME(myvk::Device::gDevice->GetCommandPool(), VK_OBJECT_TYPE_COMMAND_POOL, "MainCommandPool");
//}

//void DestroyCommandPool(VkContext& ctx)
//{
//    vkDestroyCommandPool(myvk::Device::gDevice->GetDevice(), myvk::Device::gDevice->GetCommandPool(), nullptr);
//}
